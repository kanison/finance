 ...
 */
@Aspect
public class AuthTenpayWithoutCertAspect implements Ordered {
	private AuthDispatcherFacade authDispatcher;

	/***
	 * 　　 * 切点 　　
	 */
	@Pointcut("@annotation(com.tenpay.common.aop.annotation.AuthTenpayWithoutCert)")
	...
	public Object auth(ProceedingJoinPoint joinPoint) throws Throwable {
		...
		if (authDispatcher
				.commonAuth(AuthDispatcherFacade.TENPAY_MASK, 0, args) > 0) {
