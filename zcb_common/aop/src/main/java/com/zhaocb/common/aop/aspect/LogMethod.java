...
import com.app.utils.KeyInfoMasker;
...
public class LogMethod implements Ordered {
	 ...
	 * 　　 * 切点 　　
	 */
	@Pointcut("@annotation(com.zhaocb.common.aop.annotation.LogMethod)")
	...
	public static Object logMethod(ProceedingJoinPoint joinPoint, boolean logEx)
		...
		LOG.info(KeyInfoMasker.maskKeyInfo(sb.toString()));
		Object result;
		...
		LOG
				.info(methodName + " result: "
						+ KeyInfoMasker.maskKeyInfo(printStr));
		return result;
	}
