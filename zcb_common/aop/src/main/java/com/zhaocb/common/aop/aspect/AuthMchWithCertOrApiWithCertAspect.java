 ...
 */
@Aspect
public class AuthMchWithCertOrApiWithCertAspect implements Ordered {
	private AuthDispatcherFacade authDispatcher;

	/***
	 * 　　 * 切点 　　
	 */
	@Pointcut("@annotation(com.tenpay.common.aop.annotation.AuthMchWithCertOrApiWithCert)")
	...
	public Object auth(ProceedingJoinPoint joinPoint) throws Throwable {
		...
		int authType = authDispatcher.commonAuth(AuthDispatcherFacade.API_MASK
				| AuthDispatcherFacade.MCH_MASK, AuthDispatcherFacade.API_MASK
