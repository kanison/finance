...
@Aspect
public class RemoteCacheMethod10SAspect implements Ordered {
	private RemoteCacheMethod remoteCacheMethod;

	/***
	 * 　　 * 切点 　　
	 */
	@Pointcut("@annotation(com.app.aop.annotation.RemoteCacheMethod10S)")
	...
	public Object cacheMethod(ProceedingJoinPoint joinPoint) throws Throwable {
		return remoteCacheMethod.cacheMethod(joinPoint, 10 * 1000);
	}
