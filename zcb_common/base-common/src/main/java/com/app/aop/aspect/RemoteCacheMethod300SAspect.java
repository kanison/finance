...
@Aspect
public class RemoteCacheMethod300SAspect implements Ordered {
	private RemoteCacheMethod remoteCacheMethod;

	/***
	 * 　　 * 切点 　　
	 */
	@Pointcut("@annotation(com.app.aop.annotation.RemoteCacheMethod300S)")
	...
	public Object cacheMethod(ProceedingJoinPoint joinPoint) throws Throwable {
		return remoteCacheMethod.cacheMethod(joinPoint, 300 * 1000);
	}
