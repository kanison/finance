...
@Aspect
public class RemoteCacheMethod30SAspect implements Ordered {
	private RemoteCacheMethod remoteCacheMethod;

	/***
	 * 　　 * 切点 　　
	 */
	@Pointcut("@annotation(com.app.aop.annotation.RemoteCacheMethod30S)")
	...
	public Object cacheMethod(ProceedingJoinPoint joinPoint) throws Throwable {
		return remoteCacheMethod.cacheMethod(joinPoint, 30 * 1000);
	}
