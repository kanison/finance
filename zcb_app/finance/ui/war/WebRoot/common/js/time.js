...
function()
{
	...
	{
		return new Date().getFullYear() + _splitStr + (new Date().getMonth() + 1) + _splitStr + new Date().getDate();
	};
	/**
	 * 显示日期控件
	 */
	...
	{
		_this.curControl.value = _this.year + _splitStr + Number(_this.month) + _splitStr + this.index;
