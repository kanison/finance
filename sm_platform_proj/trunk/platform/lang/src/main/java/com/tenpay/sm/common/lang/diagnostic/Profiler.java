...
import com.tenpay.sm.common.lang.enumeration.IntegerEnum;
...
public final class Profiler {
	...
	public static void start(String message) {
		String disableProfiler = ReloadableAppConfig.appConfig
				.get("disableProfiler");
		if (disableProfiler != null && disableProfiler.equals("1"))
			return;
	...
	public static final class Entry {
		...
		private Entry(Object message, Entry parentEntry, Entry firstEntry) {
			...
			this.firstEntry = (Entry) ObjectUtil
		 ...
		 *            后续行前缀
		 */
		private void toString(StringBuffer buffer, String prefix1,
				String prefix2) {
